            ...
            while not self.hit():
                ...
                if event.type == KEYDOWN:
                    if pygame.key.get_pressed()[pygame.K_UP]:
                        self.rotate()
                    if pygame.key.get_pressed()[pygame.K_LEFT] and self.hitSides() != "Left":
                        self.moveLeft()
                    if pygame.key.get_pressed()[pygame.K_RIGHT] and self.hitSides() != "Right":
                        self.moveRight()
                    if pygame.key.get_pressed()[pygame.K_DOWN] and not self.hit():
                        self.moveDown()
